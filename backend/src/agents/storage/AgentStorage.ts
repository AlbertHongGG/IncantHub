...
const DEFAULT_AGENTS: GroupedAgentConfigs = {
  image: [
    {
      id: 'ImageDescriber',
      name: '圖片描述與分析',
...
// Ensure default data is sorted
for (const key in DEFAULT_AGENTS) {
  DEFAULT_AGENTS[key].sort((a, b) => a.id.localeCompare(b.id));
}
